...
export function getNonEmptyQuestions(questions: Question[]): Question[] {
    const nonemptyexpectedQuestions = questions.filter(
        (question: Question) =>
            !(
                question.body === "" &&
                question.expected === "" &&
    ...
    return nonemptyexpectedQuestions;
}
...
export function findQuestion(
    ...
    const arrQuestion = questions.find((question: Question) =>
        question.id === id ? question : null,
    );
    return arrQuestion === undefined ? null : arrQuestion;
}
        ...
        question.id === targetId ?
            ...
            :   {
                    ...
                    options: [...question.options].map(
                        (option, currentIndex: number) =>
                            currentIndex === targetOptionIndex ?
                                (option = newOption)
                            :   option,
                    ),
                }
...
export function duplicateQuestionInArray(
    ...
    const fIndex = questions.findIndex(
        (question: Question) => question.id === targetId,
    );
    const slicedQ = questions.map((question: Question) => question);

    slicedQ.splice(fIndex + 1, 0, duplicateQuestion(newId, questions[fIndex]));
